...
require github.com/GoogleChrome/webstatus.dev/lib v0.0.0-20241229174745-146e1a05eafd
...
require (
	...
	github.com/web-platform-tests/wpt.fyi v0.0.0-20241223190530-0cee35888986 // indirect
