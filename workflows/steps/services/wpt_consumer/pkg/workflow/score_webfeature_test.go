...
func TestScore(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedOutput: map[string]wptconsumertypes.WPTFeatureMetric{
				"feature1": {
					TotalTests:        new(int64(3)),
					TestPass:          new(int64(2)),
		...
		},
		{
			...
			expectedOutput: map[string]wptconsumertypes.WPTFeatureMetric{
				"feature1": {
					TotalTests:        new(int64(3)),
					TestPass:          new(int64(2)),
					TotalSubtests:     new(int64(101)),
					SubtestPass:       new(int64(101)),
					FeatureRunDetails: nil,
				},
				"feature2": {
					TotalTests:        new(int64(3)),
					TestPass:          new(int64(2)),
					TotalSubtests:     new(int64(112)),
					SubtestPass:       new(int64(102)),
					FeatureRunDetails: nil,
				},
				"feature3": {
					TotalTests:        new(int64(2)),
					TestPass:          new(int64(1)),
					TotalSubtests:     new(int64(111)),
					SubtestPass:       new(int64(101)),
					FeatureRunDetails: nil,
				},
				"feature4": {
					TotalTests:        new(int64(1)),
					TestPass:          new(int64(0)),
					TotalSubtests:     new(int64(11)),
					SubtestPass:       new(int64(1)),
					FeatureRunDetails: nil,
				},
				"feature5": {
					TotalTests:        new(int64(1)),
				...
				"feature6": {
					TotalTests:    new(int64(6)),
					TestPass:      new(int64(3)),
					TotalSubtests: nil,
					SubtestPass:   nil,
