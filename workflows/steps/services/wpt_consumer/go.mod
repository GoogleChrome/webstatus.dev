...
require (
	...
	github.com/web-platform-tests/wpt.fyi v0.0.0-20240809174241-111bf54708c0
)
...
require (
	...
	github.com/GoogleChrome/webstatus.dev/lib/gen v0.0.0-20240812120404-fc08699998a5 // indirect
