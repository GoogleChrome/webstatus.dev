...
require (
	...
	github.com/web-platform-tests/wpt.fyi v0.0.0-20240610182640-eca6121c6932
)
...
require (
	...
	github.com/GoogleChrome/webstatus.dev/lib/gen v0.0.0-20240617233854-afc779445ed9 // indirect
