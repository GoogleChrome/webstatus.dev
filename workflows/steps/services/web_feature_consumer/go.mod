...
require (
	github.com/GoogleChrome/webstatus.dev/lib v0.0.0-20240208174325-c24fa15fb31d
...
require (
	...
	github.com/web-platform-tests/wpt.fyi v0.0.0-20240213221217-e997d8f48deb // indirect
