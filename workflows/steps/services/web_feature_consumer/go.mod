...
require (
	...
	github.com/GoogleChrome/webstatus.dev/lib/gen v0.0.0-20240730204208-441dd8d743c6
...
require (
	...
	github.com/web-platform-tests/wpt.fyi v0.0.0-20240731001722-045fc4440e99 // indirect
