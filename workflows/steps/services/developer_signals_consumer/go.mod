module github.com/GoogleChrome/webstatus.dev/workflows/steps/services/developer_signals_consumer
...
require github.com/GoogleChrome/webstatus.dev/lib v0.0.0-20251120141146-6c4cefda31cb
