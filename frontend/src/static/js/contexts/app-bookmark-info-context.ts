...
export const savedSearchHelpers = {
  ...
  getCurrentSavedSearch(info?: AppBookmarkInfo): CurrentSavedSearch {
    ...
    // We use q=saved:ID instead of a separate search_id parameter to provide a unified
    // search experience. This allows users to combine saved searches with other filters
    // in the search bar (e.g., 'saved:123 is:broken').
