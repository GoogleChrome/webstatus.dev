...
For a detailed database schema overview, see the [Generated Spanner Documentation](schema/README.md) or the [`tbls` Generated JSON Representation Of The Database](schema/schema.json).
