...
| FK_FeatureGroupKeysLookup_GroupID | FOREIGN KEY | FOREIGN KEY (GroupID) REFERENCES WebDXGroups (ID) ON DELETE CASCADE |
| FK_FeatureGroupKeysLookup_WebFeatureID | FOREIGN KEY | FOREIGN KEY (WebFeatureID) REFERENCES WebFeatures (ID) ON DELETE CASCADE |
