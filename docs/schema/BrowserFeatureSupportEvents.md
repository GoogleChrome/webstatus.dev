...
| FK_WebFeatureID | FOREIGN KEY | FOREIGN KEY (WebFeatureID) REFERENCES WebFeatures (ID) ON DELETE CASCADE |
| FK_EventBrowserRelease | FOREIGN KEY | FOREIGN KEY (EventBrowserName, EventBrowserName, EventReleaseDate, EventReleaseDate) REFERENCES BrowserReleases (BrowserName, ReleaseDate, ReleaseDate, BrowserName) ON DELETE CASCADE |
