...
CREATE UNIQUE INDEX IDX_VCSInstallations_Provider_InstallationID ON VCSInstallations(VCSProvider, VCSInstallationID);
CREATE INDEX IDX_VCSInstallations_Provider_AccountLogin ON VCSInstallations(VCSProvider, AccountLogin);
