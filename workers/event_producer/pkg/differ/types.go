...
const (
	// EnvelopeVersion defines the structure of the Envelope itself.
	EnvelopeVersion = "v1"
...
func (s FeatureListSnapshot) Version() string { return EnvelopeVersion }
...
func (d FeatureDiffSnapshot) Version() string { return EnvelopeVersion }
...
type FeatureModified struct {
	...
	BaselineChange *Change[backend.BaselineInfoStatus] `json:"baselineChange,omitempty"`
	BrowserChanges map[string]Change[string]           `json:"browserChanges,omitempty"`
}

// SummaryCategories defines the specific counts for different change types.
type SummaryCategories struct {
	QueryChanged    int `json:"query_changed,omitempty"`
	Added           int `json:"added,omitempty"`
	Removed         int `json:"removed,omitempty"`
	Moved           int `json:"moved,omitempty"`
	Split           int `json:"split,omitempty"`
	Updated         int `json:"updated,omitempty"`
	UpdatedImpl     int `json:"updated_impl,omitempty"`
	UpdatedRename   int `json:"updated_rename,omitempty"`
	UpdatedBaseline int `json:"updated_baseline,omitempty"`
}

// EventSummary matches the JSON structure stored in the database 'Summary' column.
type EventSummary struct {
	Text       string            `json:"text"`
	Categories SummaryCategories `json:"categories,omitempty"`
}
