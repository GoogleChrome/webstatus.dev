...
// BlobArtifact represents a payload that needs to be persisted to object storage (GCS/S3).
...
type DiffResult struct {
	...
	// These are critical for downstream workers to filter events (e.g. only alert on data updates).
