...
func createTestIncomingJob(t *testing.T, summary workertypes.EventSummary, triggers []workertypes.JobTrigger, eventID string) workertypes.IncomingEmailDeliveryJob {
...
func TestEmailVisitor_NilPointerGuards(t *testing.T) {
	...
	summary.AddHighlight(workertypes.SummaryHighlight{
		Type:           workertypes.SummaryHighlightTypeSplit,
		FeatureID:      "f-splt-nil",
		FeatureName:    "Nil Split Feature",
		Split:          nil,
		BaselineChange: nil,
		BrowserChanges: nil,
	})
