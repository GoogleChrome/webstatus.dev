module github.com/GoogleChrome/webstatus.dev/workers/push_delivery
...
require (
	...
	github.com/GoogleChrome/webstatus.dev/lib/gen v0.0.0-20251209015135-23da3f0e7b76 // indirect
