...
// CreateNotificationChannelDeliveryAttempt creates a new delivery attempt log and returns its ID.
func (c *Client) CreateNotificationChannelDeliveryAttempt(
	...
	return newEntityCreator[notificationChannelDeliveryAttemptMapper](c).create(ctx, req)
}
