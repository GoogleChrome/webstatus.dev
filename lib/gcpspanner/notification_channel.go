...
// CreateNotificationChannel creates a new notification channel for a user and returns its ID.
func (c *Client) CreateNotificationChannel(
	ctx context.Context, req CreateNotificationChannelRequest) (string, error) {
