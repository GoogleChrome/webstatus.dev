...
func TestUserSearchBookmark(t *testing.T) {
	...
	t.Run("user initially does not have a bookmark", func(t *testing.T) {
	...
	err = spannerClient.AddUserSearchBookmark(ctx, UserSavedSearchBookmarkInfo{
		UserID:        testUser,
	...
	err = spannerClient.DeleteUserSearchBookmark(ctx, UserSavedSearchBookmarkInfo{
		UserID:        testUser,
		SavedSearchID: *savedSearchID,
	})
	if err != nil {
