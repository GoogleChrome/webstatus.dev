...
const (
	...
	KindFeatureListDiff = "FeatureListDiffSnapshot"
	// V1FeatureListDiff identifies version v1 of the FeatureListDiffSnapshot schema.
...
func (d FeatureListDiffSnapshot) Kind() string    { return KindFeatureListDiff }
func (d FeatureListDiffSnapshot) Version() string { return V1FeatureListDiff }
...
type DiffMetadata struct {
	...
	// No guaranteed to always have a previous state ID.
...
func (d *FeatureDiff) SetResolvedQueryErrors(resolved comparables.QueryErrors) {
	d.ResolvedQueryErrors = mapComparablesQueryErrorsToV1(resolved)
}
...
type FeatureAdded struct {
	...
	QueryMatch QueryMatchStatus `json:"queryMatch,omitzero"`
}
...
type FeatureRemoved struct {
	...
	Name   string           `json:"name"`
	Reason ChangeReason     `json:"reason"`
	Diff   *FeatureModified `json:"diff,omitempty"`
}
