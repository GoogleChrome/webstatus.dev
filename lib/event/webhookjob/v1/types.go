...
func (t WebhookType) ToWorkerTypeWebhookType() workertypes.WebhookType {
	switch t {
	case WebhookTypeSlack:
		return workertypes.WebhookTypeSlack
	}

	return ""
}

func ToWebhookType(t workertypes.WebhookType) WebhookType {
	switch t {
...
type WebhookJobEvent struct {
	...
	// WebhookType is the type of webhook destination (e.g. "slack").
