...
import "github.com/GoogleChrome/webstatus.dev/lib/workertypes"
...
// BatchRefreshTrigger is the signal sent by Cloud Scheduler to the Fan-Out Worker.
// It effectively says "It is time to check all saved searches of a specific frequency".
type BatchRefreshTrigger struct {
	Frequency JobFrequency `json:"frequency"`
}

func (BatchRefreshTrigger) Kind() string       { return "BatchRefreshTrigger" }
func (BatchRefreshTrigger) APIVersion() string { return "v1" }
