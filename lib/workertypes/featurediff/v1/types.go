...
// Bytes implements the differ.Diff interface.
func (d *FeatureDiffV1) Bytes() ([]byte, error) {
	d.Sort()
	// This is a simplified serialization. In a real scenario, you'd populate the full snapshot.
	// For now, this is enough to satisfy the interface.
	return json.Marshal(d)
}

func (d *FeatureDiffV1) SetQueryChanged(changed bool) {
