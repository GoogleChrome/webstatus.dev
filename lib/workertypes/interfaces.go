...
// DiffResult is a concrete wrapper around the Diff interface.
// This allows methods to return a concrete type, satisfying the 'ireturn' linter,
// while still providing the flexibility of an interface via embedding.
